...
from evaluation.stage8_5.stage85_schema import write_jsonl  # noqa: E402
...
class GoldCaseAudit(GoldModel):
    ...
    case_id: str = Field(min_length=1, description="关联 gold_cases.jsonl 的新 case_id。")
...
def main(argv: list[str] | None = None) -> int:
    ...
    write_jsonl(args.base_dir / "processed/gold_evidence_chunks.jsonl", evidence_chunks)
    write_jsonl(args.base_dir / "processed/gold_evidence_documents.jsonl", _document_manifest(evidence_chunks))
    write_jsonl(args.base_dir / "candidates/gold_cases.jsonl", cases)
    write_jsonl(args.base_dir / "reviews/gold_case_audit.jsonl", audits)
    _write_report(args.base_dir / "reviews/gold_rewrite_report.md", cases=cases, audits=audits)
    print(
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--base-dir",
        type=Path,
        default=PROJECT_ROOT / "evaluation/stage8_5",
