...
from evaluation.stage8_5.pipelines.common.stage85_schema import build_split_manifest, write_json  # noqa: E402


_LAYOUT = stage85_layout()
DEFAULT_CASES = _LAYOUT.public_review / "schema_approved_cases.jsonl"
DEFAULT_MANIFEST = _LAYOUT.public_review / "split_manifest.json"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--allow-empty", action="store_true", help="允许当前 schema-approved case 为空。")
    return parser
