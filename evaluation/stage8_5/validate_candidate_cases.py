...
DEFAULT_CANDIDATES = PROJECT_ROOT / "evaluation/stage8_5/candidates/planner_case_candidates.jsonl"
DEFAULT_APPROVED = PROJECT_ROOT / "evaluation/stage8_5/candidates/approved_cases.jsonl"
DEFAULT_REVIEW = PROJECT_ROOT / "evaluation/stage8_5/candidates/review_queue.jsonl"
DEFAULT_REJECTED = PROJECT_ROOT / "evaluation/stage8_5/candidates/rejected_cases.jsonl"
DEFAULT_REPORT = PROJECT_ROOT / "evaluation/stage8_5/results/data_quality_report.json"


def main(argv: list[str] | None = None) -> int:
    """复用阶段 8 schema 校验候选 case，并输出通过池、审核池和拒绝池。"""
