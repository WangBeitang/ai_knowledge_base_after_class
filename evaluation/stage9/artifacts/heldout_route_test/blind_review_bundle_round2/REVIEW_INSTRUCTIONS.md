# Stage 9 heldout route test round2 clean blind review inputs

- Bundle ID：`stage9-heldout-route-test-round2-clean-cf984fdfd3d49d7f`
- Bundle version：`stage9-heldout-route-test-blind-review-bundle-v2`
...
- `review_cases.jsonl`：5 条待审 case、可复算 fingerprint 的 payload、评测契约和冻结引用。
