# Stage 9 heldout route test clean blind review inputs

- Bundle ID：`stage9-heldout-route-test-clean-c52eea2519a1a065`
- Bundle version：`stage9-heldout-route-test-blind-review-bundle-v1`
...
- `review_cases.jsonl`：25 条待审 case、可复算 fingerprint 的 payload、评测契约和冻结引用。
